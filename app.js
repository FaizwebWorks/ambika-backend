...
const corsOptions = {
  origin: function (origin, callback) {
    ...
    const allowedOrigins = [
      'https://ambika-frontend.vercel.app', // Production frontend (no trailing slash)
      'https://ambika-international-ixiy2810o-faizwebworks-projects.vercel.app', // New production frontend
      'https://ambika-international.vercel.app', // Additional Vercel URL
    ...
    if (allowedOrigins.includes(origin)) {
      ...
      if (process.env.NODE_ENV === 'development') {
        ...
        console.log(`[CORS] ⚠️ Production mode - temporarily allowing origin for debugging`);
        callback(null, true);
